    ...
    <>
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '10px', gap: '10px' }}>
          <button
            style={{ backgroundColor: '#D9D9D9', width: '100px', borderRadius: '8px', cursor: 'pointer', height: '50px' }}
          ...
          {selectedFilter === 'status' && (
            <select
              style={{ backgroundColor: '#D9D9D9', width: '150px', height: '50px', borderRadius: '8px' }}
          ...
          <>
            ...
            {emprestimos.length > 2 && (
              <div style={{ display: 'flex', justifyContent: 'center', marginTop: '20px', gap: '10px' }}>
                <button
                  style={{ cursor: 'pointer', backgroundColor: '#D9D9D9', borderRadius: '8px' }}
                ...
                {Array.from({ length: Math.ceil(emprestimos.length / 2) }, (_, index) => (
                  <button
                    key={index + 1}
                    style={{ cursor: 'pointer', backgroundColor: currentPage === index + 1 ? '#B0B0B0' : '#D9D9D9', borderRadius: '8px' }}
